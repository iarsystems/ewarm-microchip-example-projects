...
//*----------------------------------------------------------------------------
//* \fn    AT91F_InitEBI_SMC3_ForDisplayController
//* \brief Initialization of the Static Memory Controller for Chip Select 3
//*----------------------------------------------------------------------------
void AT91F_InitEBI_SMC3_ForDisplayController()
{
	// Setup NCS3 for Memory Display Controller (EBI->SMC2)
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  AT91F_InitEBI_SMC3_ForDisplayController();
