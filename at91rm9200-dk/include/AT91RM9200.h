...
#define AT91C_TC_CLKS_TIMER_DIV1_CLOCK      0 // (TC) Timer clock 1
#define AT91C_TC_CLKS_TIMER_DIV2_CLOCK      1 // (TC) Timer clock 2
#define AT91C_TC_CLKS_TIMER_DIV3_CLOCK      2 // (TC) Timer clock 3
#define AT91C_TC_CLKS_TIMER_DIV4_CLOCK      3 // (TC) Timer clock 4
#define AT91C_TC_CLKS_TIMER_DIV5_CLOCK      4 // (TC) Timer clock 5
