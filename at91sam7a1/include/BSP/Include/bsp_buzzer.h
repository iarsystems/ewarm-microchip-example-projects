...
* Description : Definitions and Standard Typedef for Buzzer (Board Support Package Layer)
* Version     : 1.00
*
...
/*******************************************************************************
Type: BSP_NOTE_T
Description: BSP Buzzer Structure Note Definitions                             
Fields:
- int freq  :               Frequence of the note                        
- int delay :              Note duration
*******************************************************************************/
typedef struct 
{
   int freq;               /* Frequence of the note                        */
