...
* Description : Definitions and Standard Typedef for
                Switches (Board Support Package Layer)
* Version     : 1.01
*
...
/*******************************************************************************
Type: BSP_SWITCH_CALLBACK_T
Description: BSP SWITCH Receive Callback Definition
Declaration: typedef *(BSP_SWITCH_CALLBACK_T)(void);
Inputs: None
*******************************************************************************/
...
/*******************************************************************************
Type: BSP_SWITCH_T
Description: BSP SWITCH Structure Definitions
Fields:
- 创BSP_SWITCH_CALLBACK_T创   *TIOB1_function : interrupt TIOB1 call back function
- 创BSP_SWITCH_CALLBACK_T创   *TIOA2_function : interrupt TIOA2 call back function
- 创BSP_SWITCH_CALLBACK_T创   *IRQ0_function : interrupt IRQ0 call back function
*******************************************************************************/
typedef struct
{
