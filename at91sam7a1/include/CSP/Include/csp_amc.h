...
/*******************************************************************************
Type: CSP_AMC_T
Description: AMC Structure Definition
Fields:
- 创CSP_REGISTER_T创 CSR[8] :               AMC Chip Select Register           
- 创CSP_REGISTER_T创 RCR :                  AMC Remap Control Register         
- 创CSP_REGISTER_T创 MCR :                  AMC Memory Control Register        
*******************************************************************************/
typedef struct
{ 
