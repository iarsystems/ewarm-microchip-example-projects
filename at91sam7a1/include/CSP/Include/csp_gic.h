...
/*******************************************************************************
Type: CSP_GIC_T
Description: GIC Structure Definition
Fields:
- 创CSP_REGISTER_T创  SMR[NB_INTERRUPT] :    Source Mode Registers              
- 创CSP_REGISTER_T创  SVR[NB_INTERRUPT] :    Source Vector Registers            
- 创CSP_REGISTER_T创  IVR :                  IRQ Vector Register                 
- 创CSP_REGISTER_T创  FVR :                  FIQ Vector Register                 
- 创CSP_REGISTER_T创  ISR :                  Interrupt Status Register          
- 创CSP_REGISTER_T创  IPR :                  Interrupt Pending Register           
- 创CSP_REGISTER_T创  IMR :                  Interrupt Mask Register            
- 创CSP_REGISTER_T创  CISR :                 Core Interrupt Status Register     
- 创CSP_REGISTER_T创  ReservedA :           
- 创CSP_REGISTER_T创  ReservedB :           
- 创CSP_REGISTER_T创  IECR :                 Interrupt Enable Command Register   
- 创CSP_REGISTER_T创  IDCR :                 Interrupt Disable Command Register  
- 创CSP_REGISTER_T创  ICCR :                 Interrupt Clear Command Register   
- 创CSP_REGISTER_T创  ISCR :                 Interrupt Set Command Register     
- 创CSP_REGISTER_T创  EOICR :                End of Interrupt Command Register  
- 创CSP_REGISTER_T创  SPU :                  Spurious Vector Register           
*******************************************************************************/
typedef struct
{ 
