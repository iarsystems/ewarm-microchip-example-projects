...
/*******************************************************************************
Type: CSP_ST_CHANNEL_T
Description: ST Channel Structure Definition
Fields:
- 创CSP_REGISTER_T创 PR :                    Channel Prescalar Register
- 创CSP_REGISTER_T创 CT :                    Channel Counter Register
*******************************************************************************/
typedef struct
{ 
...
/*******************************************************************************
Type: CSP_ST_T
Description: ST Structure Definition
Fields:
...
- 创CSP_ST_CHANNEL_T创  CHANNEL[NB_ST_CHANNEL] :  ST Channels                  
- 创CSP_REGISTER_T创    ReservedD[92] : 
- 创CSP_REGISTER_T创    CCV[NB_ST_CHANNEL] :   Current Counter Value Register  
*******************************************************************************/
typedef struct 
{ 
...
extern void CSP_STReload(CSP_ST_T *const st, U8_T channel, U16_T counter);
