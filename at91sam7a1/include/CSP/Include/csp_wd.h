...
/*******************************************************************************
Type: CSP_WD_T
Description: WD Structure Definition
Fields:
- 创CSP_REGISTER_T创  ReservedA[24] :
- 创CSP_REGISTER_T创  CR :                     Control Register                
- 创CSP_REGISTER_T创  MR :                     Mode Register                   
- 创CSP_REGISTER_T创  OMR :                    Overflow Mode Register          
...
- 创CSP_REGISTER_T创  TR :                     Test Register                   
- 创CSP_REGISTER_T创  CTR :                    Counter Test Register           
- 创CSP_REGISTER_T创  PTR :                    Preload Test Register           
*******************************************************************************/
typedef struct
{ 
   ...
   CSP_REGISTER_T  TR;                    /* Test Register                   */
   CSP_REGISTER_T  CTR;                   /* Counter Test Register           */
   CSP_REGISTER_T  PTR;                   /* Preload Test Register           */
} CSP_WD_T;
...
#define SYSCLK          (0x01ul << 3)     /* SYSCLK Mask                     */
#define SYSCLK_EXT      (0x00ul << 3)     /* WDCLK is External Clock         */
#define SYSCLK_SYS      (0x01ul << 3)     /* WDCLK is System Clock           */

/* SYSCAL : System Clock Prescalar Value                                     */ 
#define WD_SYSCAL_MASK  (0x7FFul << 4)             /* Mask                   */     
#define WD_SYSCAL(val)  (((val) & 0x7FFul) << 4)   /* Writing Mask           */

/* HPCV : High Preload Counter Value                                         */
#define HPCV_MASK       (0x1Ful << 16)             /* Mask                   */
#define HPCV(val)       (((val) & 0x1Ful) << 16)   /* Writing Mask           */
...
#define EXTEN           (0x01ul << 2)     /* External signal Enable          */
...
* TR : WD Test Register
******************************************************************************/
#define TMEN            (0x01ul << 0)     /* Test Mode Enabled               */
#define WDRV            (0x01ul << 1)     /* Watchdog Reset Value            */
#define WDIV            (0x01ul << 2)     /* Watchdog Interrupt Value        */

/******************************************************************************
* CTR : WD Counter Test Register
******************************************************************************/
#define COUNT           (0xFFFFul << 0)   /* Counter Mask                    */
#define RESET           (0x01ul << 16)    /* Watchdog Counter Resetting      */

/******************************************************************************
* PTR : WD Preload Test Register
******************************************************************************/
#define CTPR            (0xFFFFul << 0)   /* Counter Test Preload Register Mask */
...
/* TR : WD Test Register                                                     */
#define CSP_WD_GET_TR(wd)           ((wd)->TR)

/* CTR : WD Counter Test Register                                            */
#define CSP_WD_GET_CTR(wd)          ((wd)->CTR)

/* PTR : WD Preload Test Register                                            */
#define CSP_WD_GET_PTR(wd)          ((wd)->PTR)


/******************************************************************************
********************** WD External Functions Declaration **********************
******************************************************************************/
extern void CSP_WDInit(CSP_WD_T *const wd, U32_T mode, U32_T overflow_mode);
