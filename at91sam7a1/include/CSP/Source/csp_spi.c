...
- <*cmd_tx> = Pointer to an array where command packet sent is stored
- <*data>   = Pointer to an array where data packet received will be stored
- <length>  = Number of byte to receive
Functions called  : 创CSP_PDCInitTx创, 创CSP_PDCInitRx创, 创CSP_PDCStartRx创,
                    创CSP_PDCStartTx创
Returns           : None
******************************************************************************/
...
Functions called  : 创CSP_PDCInitTx创, 创CSP_PDCStartTx创
Returns           : None
******************************************************************************/
