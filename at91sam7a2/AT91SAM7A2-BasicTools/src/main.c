...
void GPT_LED_init(void)
{
      ...
      /* Timer channel 0 RED LED => TIOA ORANGE LED => TIOB */
      ...
      /* Timer channel 1 Green LED => TIOA */
...
int main (void)
{
  ...
  /* Light off all LEDs */
   ...
   BSP_LCDDisplayMessage(LCD_ROW_0, LCD_COLUMN_0, "** AT91SAM7A2 **");
   BSP_LCDDisplayMessage(LCD_ROW_1, LCD_COLUMN_0, "** LED SWING  **");
   while(1)
   {
   		/* Wait */
   		wait();
