...
****************************************************************************/
const U32_T  BSP_CANController_a_u32[BSP_NB_CAN_IO]   = 
{
  CAN0_BASE_ADDRESS, CAN1_BASE_ADDRESS, CAN2_BASE_ADDRESS
};

const U32_T  BSP_CANMode_a_u32[BSP_NB_CAN_IO]  = 
{
  //0x552204, 0x552204, 0x552204
	0x0012110E, 0x0012110E, 0x0012110E
};

const U8_T  BSP_CANNumberOfMailbox[BSP_NB_CAN_IO]  = 
{
  16, 16, 32
};

const U8_T  BSP_CANAckLimit_a_u8[BSP_NB_CAN_IO] = 
{
  3, 3, 3  
};