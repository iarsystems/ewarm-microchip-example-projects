...
#include <Microchip/iosama7g54.h>
...
int32_t main(void)
{
  ...
  PIO_REGS->PIO_GROUP[1].PIO_MSKR = 0x100;

  PIO_REGS->PIO_GROUP[1].PIO_CFGR =  0x100;

  PIO_REGS->PIO_GROUP[0].PIO_MSKR = 0x2000;

  PIO_REGS->PIO_GROUP[0].PIO_CFGR =  0x100;

  while (1)
  {
    PIO_REGS->PIO_GROUP[0].PIO_SODR = 0x2000;
    _delay(5000000);
    PIO_REGS->PIO_GROUP[0].PIO_CODR = 0x2000;
    _delay(5000000);
  }
}
